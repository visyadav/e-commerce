...
const APP_NAME = "E-Commerce Admin Panel";
const BASE_URL = ("TURBOPACK compile-time value", "http://localhost:5185") || "http://localhost:5185";
...
async function request(endpoint, options = {}) {
    ...
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$app$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${endpoint}`, config);
    if (!res.ok) {
...
const apiClient = {
    get: (endpoint, headers)=>request(endpoint, {
            method: "GET",
            headers
        }),
    getPaginated: (endpoint, headers)=>requestPaginated(endpoint, {
            method: "GET",
            headers
        }),
    ...
    delete: (endpoint, headers)=>request(endpoint, {
            method: "DELETE",
            headers
        }),
    patch: (endpoint, body, headers)=>request(endpoint, {
            method: "PATCH",
            body,
            headers
        })
...
"[project]/src/services/auth/auth-service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const authService = {
    login: (payload)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post(AUTH_ENDPOINTS.LOGIN, payload),
    register: (payload)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post(AUTH_ENDPOINTS.REGISTER, payload),
    logout: ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].remove("token");
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].remove("user");
    ...
    getToken: ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("token") || null;
        }
    ...
    getUser: ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            const userStr = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("user");
            if (userStr) {
                try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/auth/auth-service.ts [app-client] (ecmascript)");
...
function AuthProvider({ children }) {
    _s();
    const [state, dispatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReducer"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authReducer"], __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialAuthState"]);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const expiryTimerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const handleExpiry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[handleExpiry]": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].logout();
            dispatch({
                type: "LOGOUT"
            });
            router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN);
        }
    }["AuthProvider.useCallback[handleExpiry]"], [
        router
    ]);
    const scheduleExpiryTimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[scheduleExpiryTimer]": (token)=>{
            ...
            expiryTimerRef.current = setTimeout({
                "AuthProvider.useCallback[scheduleExpiryTimer]": ()=>{
                    handleExpiry();
                }
            }["AuthProvider.useCallback[scheduleExpiryTimer]"], msUntilExpiry);
        }
    }["AuthProvider.useCallback[scheduleExpiryTimer]"], [
        handleExpiry
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getToken();
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getUser();
            if (token) {
                const expiry = getTokenExpiry(token);
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email, password)=>{
            try {
                ...
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login({
                    email,
                    password
                });
                if (data.accessToken) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].setToken(data.accessToken);
                    dispatch({
                        type: "SET_TOKEN",
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].setUser(user);
                dispatch({
                    type: "SET_USER",
                    payload: user
                });
    ...
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[register]": async (firstName, lastName, email, password, phoneNumber)=>{
            try {
                dispatch({
                    type: "SET_LOADING",
                    payload: true
                ...
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].register({
                    firstName,
                    lastName,
                    email,
                    password,
    ...
    const updateUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[updateUser]": (updates)=>{
            if (state.user) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2f$auth$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].setUser(updatedUser);
                dispatch({
                    type: "SET_USER",
                    payload: updatedUser
                });
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthContext"].Provider, {
        value: contextValue,
        children: children
    }, void 0, false, {
...
_s(AuthProvider, "qHG+i3/KgBfrZEaYSxeZS2MVOQY=", false, function() {
    return [
...
function useAuth() {
    _s();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthContext"]);
    if (!context) {
...
"[project]/src/providers/color-theme-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ColorThemeProvider({ children }) {
    _s();
    const { state } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(ColorThemeProvider, "Vm86jwXZlQ/K87NL2n1lki1cP90=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "ColorThemeProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_03gc8g6._.js.map